...
x_window_lstm_std= scaler_X.transform(x_window_lstm)
...
# Load model
model = TransformerRegressor(input_dim=X_train_tensor.shape[2], output_dim=y_train_tensor.shape[1]).to(device)
