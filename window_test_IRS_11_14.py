...
x_test_15= pd.read_csv('window_sensor_11_14.csv')
y_test_15= pd.read_csv('attack_14.csv')
...
y_true= pd.read_csv('window_inverter_11_14.csv')
...
from window_test_13 import voltage_true
from window_test_13 import current_true
...
plt.plot(current_true, label='True Current (A)', color='green')
...
plt.figure(figsize=(8, 6))
plt.plot(voltage_true, label='True Voltage (V)', color='green')
