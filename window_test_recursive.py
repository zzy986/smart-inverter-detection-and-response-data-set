...
time_interval_hours = 5 / 60  # 如果是5分钟间隔

# 计算真实功率和预测功率
true_power = y_test_original[:, 0] * y_test_original[:, 1]  # 真实功率 = 真实电压 * 真实电流
predicted_power = predicted_values[:, 0] * predicted_values[:, 1]  # 预测功率 = 预测电压 * 预测电流
